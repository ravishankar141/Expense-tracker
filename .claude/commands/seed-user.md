...
- Name: a realistic Indian first last + last name
- Email: derived from the name with a randon 2-3 digit
 
 - number suffix (e.g. mohan.    [sharma93@gmail.com](mailto:sharma91@gmail.com))
...
3. Inserts the user into the database using the same
    - get_db() pattern found in [db.py](http://db.py/).
